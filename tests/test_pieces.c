...
TEST(test_rotate_270)
{
    ...
    Board board = {
        {-1, -1, -1, -1, -1, -1, -1, -1},
        {42, 35, 28, 21, 14, 7, 0, -1},
        {43, 36, 29, 22, 15, 8, 1, -1},
        {44, 37, 30, 23, 16, 9, 2, -1},
        {45, 38, 31, 24, 17, 10, 3, -1},
        {46, 39, 32, 25, 18, 11, 4, -1},
        {47, 40, 33, 26, 19, 12, 5, -1},
